    ...
    return (
      ...
      >
        ...
        >
          ...
          <Box sx={{ width: 90, height: 120, position: "absolute", left: `calc(50% - 60px - 25px)`, zIndex: 3, opacity: 0.6, transform: "scale(0.85)", pointerEvents: "none" }}>
            <CarCard {...allCars[1]} maxWidth={90} maxHeight={120} />
          </Box>
          <Box sx={{ width: 90, height: 120, position: "absolute", left: `calc(50% + 60px + 25px - 90px)`, zIndex: 3, opacity: 0.6, transform: "scale(0.85)", pointerEvents: "none" }}>
            <CarCard {...allCars[3]} maxWidth={90} maxHeight={120} />
          </Box>
          <Box sx={{ width: 60, height: 90, position: "absolute", left: `calc(50% - 60px - 45px)`, zIndex: 2, opacity: 0.45, transform: "scale(0.7)", pointerEvents: "none" }}>
            <CarCard {...allCars[0]} maxWidth={60} maxHeight={90} />
          </Box>
          <Box sx={{ width: 60, height: 90, position: "absolute", left: `calc(50% + 60px + 45px - 60px)`, zIndex: 2, opacity: 0.45, transform: "scale(0.7)", pointerEvents: "none" }}>
